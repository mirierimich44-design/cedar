...
function toggle_dsp_input() {
    ...
    // Always show both inputs to allow reverse calculation
    $('#single_dsp').removeClass('hide');
    $('#single_dsp_inc_tax').removeClass('hide');

    // Make sure variable product inputs are also visible
    ...
    // Update labels if needed (optional, keeping original label logic but modified for visibility)
