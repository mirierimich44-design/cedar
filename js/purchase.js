$(document).ready(function () {
    ...
    $(document).on('change', '.purchase_unit_cost_without_discount', function () {
        ...
        //Tax
        var tax_rate = __read_number(row.find('input.row_tax_percent'), true);
        ...
        __write_number(row.find('input.row_tax_amount'), tax, true);
    ...
    $(document).on('change', '.row_tax_percent', function () {
        var row = $(this).closest('tr');
        var tax_rate = __read_number($(this), true);
    ...
    $(document).on('change', '.row_tax_amount', function () {
        var row = $(this).closest('tr');
        var tax = __read_number($(this), true);
        var purchase_before_tax = __read_number(row.find('.purchase_unit_cost'), true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);

        var tax_rate = 0;
        if (purchase_before_tax != 0) {
            tax_rate = (tax / purchase_before_tax) * 100;
        }

        __write_number(row.find('input.row_tax_percent'), tax_rate, true);
        __write_number(row.find('input.purchase_product_unit_tax'), tax, true);
