    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'hide_selling_price', in_array('hide_selling_price', $role_permissions),
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'hide_stock_quantity', in_array('hide_stock_quantity', $role_permissions),
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_profit', in_array('view_profit', $role_permissions),['class' => 'input-icheck']); !!}
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.view', in_array('job.view', $role_permissions), [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.create', in_array('job.create', $role_permissions), [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.create' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.update', in_array('job.update', $role_permissions), [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.update' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.delete', in_array('job.delete', $role_permissions), [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.delete' ) }}
                </label>
              </div>
            </div>
          </div>
