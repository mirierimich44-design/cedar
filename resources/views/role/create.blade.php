    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_profit', false,['class' => 'input-icheck']); !!}
                {{ __('lang_v1.view_profit') }}
              </label>
        ...
        <div class="row check_group">
            ...
            @if(in_array('pos_sale', $enabled_modules))
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'create_credit_sale', false, ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-9">
        ...
        <div class="col-md-12">
          <div class="checkbox">
            <label>
              ...
              <div class="checkbox">
              <label>
              {!! Form::checkbox('permissions[]', 'view_cash_register_product_details', false, 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.view', false, [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.create', false, [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.create' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.update', false, [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.update' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'job.delete', false, [ 'class' => 'input-icheck']); !!} {{ __( 'role.job.delete' ) }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'access_etims_report', false, ['class' => 'input-icheck']); !!} {{ __('role.access_etims_report') }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.asset.view', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.asset.view') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.asset.create', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.asset.create') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.asset.update', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.asset.update') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.asset.delete', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.asset.delete') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.dealer.view', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.dealer.view') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.dealer.create', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.dealer.create') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.dealer.update', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.dealer.update') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.dealer.delete', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.dealer.delete') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.dealer.verify_docs', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.dealer.verify_docs') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.agreement.view', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.agreement.view') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.agreement.create', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.agreement.create') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.agreement.sign', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.agreement.sign') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.agreement.terminate', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.agreement.terminate') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.retrieval.view', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.retrieval.view') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.retrieval.initiate', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.retrieval.initiate') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.retrieval.execute', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.retrieval.execute') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.document.view', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.document.view') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.document.download', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.document.download') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.document.delete', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.document.delete') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.compliance.view', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.compliance.view') }}
            </label></div></div>
            <div class="col-md-3"><div class="checkbox"><label>
              {!! Form::checkbox('permissions[]', 'cooler.report.view', false, ['class' => 'input-icheck']); !!} {{ __('role.cooler.report.view') }}
            </label></div></div>
          </div>
        </div>
        @endif
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'stocktake.view', false, ['class' => 'input-icheck']); !!} View / Conduct Stocktake
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dda.view', false, ['class' => 'input-icheck']); !!} View DDA Register (dashboard, dispense log, stock, sales)
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dda.manage', false, ['class' => 'input-icheck']); !!} Manage DDA (add/edit drugs, prescriptions, destruction records)
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'send_notifications', false, ['class' => 'input-icheck']); !!} Send SMS &amp; Notifications
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'send_notifications', false, ['class' => 'input-icheck']); !!} Send WhatsApp Messages &amp; Notifications
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ip_access.access', false, ['class' => 'input-icheck']); !!}
