	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				{{-- Distribute Discount Option --}}
				<div class="row @if(!$is_discount_enabled) hide @endif">
				    <div class="col-md-12">
				        <div class="checkbox" style="margin-top: 10px;">
				            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
				                <input type="checkbox" id="distribute_discount_checkbox" value="1" style="margin: 0;">
				                <span style="font-size: 12px; color: #64748b;">
				                    <i class="fas fa-arrows-alt-v"></i> Distribute total discount proportionally across all products
				                </span>
				            </label>
				        </div>
				    </div>
