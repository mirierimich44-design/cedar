...
<div class="page-modern">
        ...
        <div class="pg-banner-inner">
            <div class="pg-banner-title">
                ...
                <div>
                    ...
                    <p class="pg-subtitle">{{ __('lang_v1.all_your_discounts', [], null) ?: 'Manage discounts &amp; promotions' }} &middot; {{ session('business.name') }}</p>
                </div>
            </div>
    ...
    <section class="content">
        @component('components.widget', ['class' => 'box-primary', 'title' => __('sale.discount')])
            @can('brand.view')
...
<script type="text/javascript">
    ...
    $(document).on('click', '.activate-discount', function(e) {
        ...
        $.ajax({
            method: "get", url: href, dataType: "json",
            success: function(result) {
                if (result.success == true) { toastr.success(result.msg); discounts_table.ajax.reload(); }
            ...
            ajax: {
                ...
                processResults: function(data) {
                    ...
                    for (var item in data) {
                        results.push({ id: data[item].variation_id, text: data[item].text });
                    }
