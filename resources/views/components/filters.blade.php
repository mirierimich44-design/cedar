<div class="tw-transition-all tw-mb-4 tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl tw-ring-1 hover:tw-shadow-md tw-ring-gray-200" style="overflow:hidden;">
    <div style="background:linear-gradient(135deg,#334155 0%,#475569 100%); padding:10px 16px; cursor:pointer;" data-toggle="collapse" data-parent="#accordion" href="#collapseFilter">
