        ...
        <tr>
          ...
          <td>
            <span class="display_currency" data-currency_symbol="true">
              {{$detail->unit_purchase_price}}
            </span>
          </td>
          <td>
            @php
                $unit_selling_price = 0;
                if($detail->total_quantity > 0){
                    $unit_selling_price = $detail->total_amount / $detail->total_quantity;
                }
            @endphp
            <span class="display_currency" data-currency_symbol="true">
              {{$unit_selling_price}}
          ...
          <td>
            @php
                $gross_profit = $detail->total_amount - ($detail->unit_purchase_price * $detail->total_quantity);
