    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('etims_tax_category', ['A' => '16% (Category A)', 'B' => '8% (Category B)', 'C' => '0% (Category C)', 'D' => 'Non-Taxable (Category D)', 'E' => 'Exempt (Category E)'], 'A', ['class' => 'form-control select2', 'required']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('etims_uom', 'eTIMS Unit of Measure:*') !!}
                {!! Form::select('etims_uom', ['U' => 'Units (U)', 'KG' => 'Kilograms (KG)', 'M' => 'Metres (M)', 'L' => 'Litres (L)'], 'U', ['class' => 'form-control select2', 'required']); !!}
            </div>
        </div>
                ...
                <div class="row text-center mt-20">
                    <div class="col-md-12">
                        <div class="flex-center" style="gap: 15px; display: flex; justify-content: center; flex-wrap: wrap;">
                            ...
                            <button type="submit" name="submit_type" value="submit_n_add_selling_prices" class="tw-dw-btn tw-dw-btn-lg tw-text-white btn-material submit_product_form" style="background: linear-gradient(135deg, #FF9800 0%, #F57C00 100%) !important; border: none !important; min-width: 200px;">
                                <i class="fa fa-list-alt"></i> @lang('lang_v1.save_n_add_selling_price_group_prices')
                            </button>
                            @endif

                            @can('product.opening_stock')
                            <button id="opening_stock_button" @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) disabled @endif type="submit" name="submit_type" value="submit_n_add_opening_stock" class="tw-dw-btn tw-dw-btn-lg tw-text-white btn-material submit_product_form" style="background: linear-gradient(135deg, #9c27b0 0%, #7b1fa2 100%) !important; border: none !important; min-width: 200px;">
                                <i class="fa fa-database"></i> @lang('lang_v1.save_n_add_opening_stock')
                            </button>
                            @endcan

                            <button type="submit" name="submit_type" value="save_n_add_another" class="tw-dw-btn tw-dw-btn-lg tw-text-white btn-material submit_product_form" style="background: linear-gradient(135deg, #FF5722 0%, #E64A19 100%) !important; border: none !important; min-width: 200px;">
                                <i class="fa fa-plus-circle"></i> @lang('lang_v1.save_n_add_another')
                            </button>

                            <button type="submit" name="submit_type" value="submit" class="tw-dw-btn tw-dw-btn-lg tw-text-white btn-material submit_product_form" style="background: linear-gradient(135deg, #4CAF50 0%, #388E3C 100%) !important; border: none !important; min-width: 150px;">
...
@section('css')
<style>
    /* Defensive CSS to ensure inputs in material wrappers are clickable */
    ...
    .material-input-wrapper input {
        position: relative;
        z-index: 2; /* Ensure input is above wrapper */
