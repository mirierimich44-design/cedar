{{-- Sidebar colours come from CSS variables set in :root {} (css.blade.php).
     Static gradient rules are in public/css/apex-overrides.css (.side-bar). --}}
...
<aside class="side-bar tw-relative tw-hidden tw-h-full tw-w-64 xl:tw-w-64 lg:tw-flex lg:tw-flex-col tw-shrink-0">
    ...
    <a href="{{route('home')}}"
        ...
        <span class="logo-icon-gradient" style="width:34px;height:34px;border-radius:9px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
