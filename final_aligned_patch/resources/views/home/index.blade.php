...
@endphp
    ...
    <div class="tw-pb-6 xl:tw-pb-0" style="background: linear-gradient(to right, var(--theme-dark), var(--theme-main));">
        ...
        @if (auth()->user()->can('dashboard.data'))
            <div class="tw-px-5 tw-my-10">
                <!-- MORNING DIGEST WIDGET -->
                <div class="tw-transition-all tw-duration-200 tw-shadow-sm tw-rounded-xl tw-ring-1 tw-ring-gray-200 tw-bg-white">
                    <div class="tw-px-5 tw-py-4 tw-border-b tw-border-gray-100 tw-flex tw-items-center tw-justify-between">
                        <h3 class="tw-text-lg tw-font-bold tw-text-gray-800 tw-m-0 tw-flex tw-items-center tw-gap-2">
                            <span style="width:32px;height:32px;background:linear-gradient(135deg,#6366f1,#4f46e5);border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                <i class="fa fa-coffee tw-text-white tw-text-sm"></i>
                            </span>
                            Morning Digest <span class="tw-text-xs tw-font-normal tw-text-gray-400 tw-ml-1">(Yesterday & Today)</span>
                        </h3>
                        <button type="button" class="tw-text-gray-400 hover:tw-text-indigo-600 tw-transition-colors" id="refresh_morning_digest" title="Refresh">
                    ...
                    <div class="tw-p-5">
                        <div id="morning_digest_content">
                            <div class="text-center" id="morning_digest_loader" style="padding: 20px 0;">
                                ...
                                <p class="tw-text-sm tw-text-gray-500 tw-mt-2">Brewing your morning digest...</p>
                            </div>
                            <div id="morning_digest_data" class="tw-grid tw-grid-cols-1 tw-gap-4 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5" style="display:none;">
                                <div class="tw-p-4 tw-rounded-xl tw-bg-gray-50 tw-border tw-border-gray-100">
                                    <p class="tw-text-xs tw-font-bold tw-text-gray-400 tw-uppercase tw-tracking-wider tw-m-0">Yesterday Sales</p>
                                    <h4 class="tw-font-bold tw-text-gray-900 tw-m-0 tw-mt-1 tw-text-xl tw-font-mono"><span class="display_currency" data-currency_symbol="true" id="md_yesterday_sales">0</span></h4>
                                </div>
                                <div class="tw-p-4 tw-rounded-xl tw-bg-gray-50 tw-border tw-border-gray-100">
                                    <p class="tw-text-xs tw-font-bold tw-text-gray-400 tw-uppercase tw-tracking-wider tw-m-0">?? Expiry Risk (< 30d)</p>
                                    <h4 class="tw-font-bold tw-text-gray-900 tw-m-0 tw-mt-1 tw-text-xl tw-font-mono">
                                        <span class="display_currency" data-currency_symbol="true" id="md_expiry_value">0</span>
                                    </h4>
                                    <p class="tw-text-xs tw-text-gray-500 tw-m-0" id="md_expiry_count">0 items</p>
                                </div>
                                <div class="tw-p-4 tw-rounded-xl tw-bg-gray-50 tw-border tw-border-gray-100">
                                    <p class="tw-text-xs tw-font-bold tw-text-gray-400 tw-uppercase tw-tracking-wider tw-m-0">?? Top Product</p>
                                    <h4 class="tw-font-bold tw-text-gray-900 tw-m-0 tw-mt-1 tw-text-lg tw-truncate" id="md_top_product" title="">N/A</h4>
                                </div>
                                <div class="tw-p-4 tw-rounded-xl tw-bg-gray-50 tw-border tw-border-gray-100">
                                    <p class="tw-text-xs tw-font-bold tw-text-gray-400 tw-uppercase tw-tracking-wider tw-m-0">?? Dead Stock (> 90d)</p>
                                    <h4 class="tw-font-bold tw-text-gray-900 tw-m-0 tw-mt-1 tw-text-xl tw-font-mono"><span id="md_dead_stock">0</span> <span class="tw-text-sm tw-font-normal tw-text-gray-500">items</span></h4>
                                </div>
                            </div>
                        </div>
                        <div class="tw-mt-6">
                            <div class="tw-flex tw-items-center tw-gap-2 tw-text-sm tw-text-indigo-600 tw-bg-indigo-50 tw-p-3 tw-rounded-lg tw-border tw-border-indigo-100">
                                <i class="fa fa-lightbulb-o"></i>
                                <span><strong>Insights:</strong> Check <a href="{{ route('reports.daily_summary') }}" class="tw-font-bold tw-underline">Daily Summary</a> for breakdown or <a href="{{ action([\App\Http\Controllers\ReportController::class, 'getDeadStockReport']) }}" class="tw-font-bold tw-underline">Dead Stock</a> to clear capital.</span>
                            </div>
                        </div>
                    </div>
                </div>
