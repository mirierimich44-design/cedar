<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      {{--#JCN Add the image for the categorie--}}
      <div class="form-group">
        {{-- image file name from slug--}}
        <img style="width: 80px" class="img-tumbnail " src="{{asset('/uploads/category_images/' . $category->image)}}" >
        {!! Form::label('category_image', __('lang_v1.upload_image') . ':') !!}
        {!! Form::file('category_image',  ['id' => 'category_image', 'accept' => 'image/*', 'class' => 'category_image_box']) !!}
...
<script type="text/javascript">
    //#JCN Format the field to get image
