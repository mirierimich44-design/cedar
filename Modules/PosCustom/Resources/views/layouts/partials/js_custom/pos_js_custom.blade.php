    ...
    $(document).ready(function() {
        ...
        $('#customer_id').on('select2:select', function(e) {
            ...
            // store on customer change POSDisplay UPOS
    ...
    function change_status_tab(in_category_id, flag, parent = null  )
        {
            ...
            if (el[0] ) //Use for the drawer categories 
            {
                ...
                if (flag == 1){
                    //Case category bar
                    el[0].classList.add(theme_tab);
                    el[0].style.color = 'white';
                    el[0].style.border = "2px solid white";
                }else{
                    //Case category bar
                    el[0].classList.remove(theme_tab);
    ...
    function get_product_suggestion_list(category_id, brand_id, location_id, url = null, is_enabled_stock = null, repair_model_id = null) {
        ...
        */
        ...
        var w_product = $('input#ps_width_product').val();
    
        /*#JCN build a scale for the product to determinate the pagination*/
    
        var elem_div_main = document.getElementById('product_list_body');
    
        var w = elem_div_main.clientWidth;
        var h = elem_div_main.clientHeight;
        ...
        */
        ...
        var w_paginate = ( Math.round(w/w_product)* Math.round(h/w_product)); //Determina # de elementos a mostrar en el div
        console.log('w_paginate = ' + w_paginate);        
         
        //toastr.info('WSize:[ W=' + w + ' H=' + h +' ]' + ' Paginate:[' +w_paginate + ']' );
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        //#JCN POS Display V Own
                        /* console.log('111111111111111111111111 modifiers 111111111111111111111111XXX'); */
                        // save_data_local_storage(new_row_html);
    ...
    function reset_pos_form(){
        ...
        //#JCNThe pos_redirect_url is in layouts/partials/header-pos
