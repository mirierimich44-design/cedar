    ...
    <div class="pos-form-actions tw-bg-white tw-fixed tw-right-0 tw-bottom-0 tw-flex tw-p-1 tw-w-full !tw-items-center tw-justify-between flex-col md:flex-row sm:flex-col lg:flex-row  
        ...
        <div class="tw-flex tw-flex-row tw-w-full !tw-items-center tw-justify-between md:!tw-hidden !tw-gap-3">
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        text-green-700 hover:text-white border border-green-700 hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <p class="text-nowrap"><img style="width:30px; height:20px; min-width:30px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA"></p>
                </button>
            @endif
        ...
        <div class=" tw-flex tw-flex-row w-5/6 tw-gap-4 tw-justify-center tw-hidden md:tw-flex tw-overflow-x-auto">
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        text-green-700 hover:text-white border-2 border-green-500 font-medium rounded-lg text-sm px-3 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <span style="white-space: nowrap; display: flex; align-items: center; justify-content: center;">
                        <img style="width:44px; height:34px; min-width:40px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA">
                    </span>
                </button>
            @endif     
...
@elseif ($poscustom_btnstyle == 's1t')
    ...
    <div class="pos-form-actions tw-bg-white tw-fixed tw-right-0 tw-bottom-0 tw-flex tw-p-1 tw-w-full !tw-items-center tw-justify-between flex-col md:flex-row sm:flex-col lg:flex-row  
        ...
        <div class="tw-flex tw-flex-row tw-w-full tw-justify-center md:!tw-hidden !tw-gap-3">
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print {{ $tab_class }} @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        text-green-700 hover:text-white border border-green-700 hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium text-sm px-5 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <p class="text-nowrap"><img style="width:30px; height:20px; min-width:30px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA"></p>
                </button>
            @endif
        ...
        <div class=" tw-flex tw-flex-row w-5/6 tw-gap-4 tw-justify-center tw-hidden md:tw-flex tw-overflow-x-auto">
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print {{ $tab_class }} @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        text-green-700 hover:text-white border-2 border-green-500 font-medium text-sm px-3 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <span style="white-space: nowrap; display: flex; align-items: center; justify-content: center;">
                        <img style="width:44px; height:34px; min-width:40px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA">
                    </span>
    ...
    <div class="pos-form-actions {{ $theme_pos_class }} tw-bg-white tw-fixed tw-right-0 tw-bottom-0 tw-flex tw-p-1 tw-w-full !tw-items-center tw-justify-between flex-col md:flex-row sm:flex-col lg:flex-row  
        ...
        <div class="tw-flex tw-flex-row tw-w-full tw-gap-1 !tw-items-center tw-justify-between md:!tw-hidden">
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        border tw-border-white text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 font-medium rounded-lg text-sm px-5 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <p class="text-nowrap"><img style="width:30px; height:20px; min-width:30px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA"></p>
                </button>
            @endif
        ...
        <div class=" tw-flex tw-flex-row w-5/6 tw-gap-4 tw-justify-center tw-hidden md:tw-flex tw-overflow-x-auto
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        border-2 tw-border-green-500 text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <span style="white-space: nowrap; display: flex; align-items: center; justify-content: center;">
                        <img style="width:44px; height:34px; min-width:40px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA">
                    </span>
    ...
    <div class="pos-form-actions {{ $theme_pos_class }} {{-- tw-bg-white --}} tw-fixed tw-right-0 tw-bottom-0 tw-flex tw-p-1 tw-w-full !tw-items-center tw-justify-between flex-col md:flex-row sm:flex-col lg:flex-row  
        ...
        <div class="tw-flex tw-flex-row tw-w-full tw-gap-1 !tw-items-center tw-justify-between md:!tw-hidden">
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print {{ $tab_class }} @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        border tw-border-white text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium text-sm px-5 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <p class="text-nowrap"><img style="width:30px; height:20px; min-width:30px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA"></p>
                </button>
            @endif
        ...
        <div class=" tw-flex tw-flex-row w-5/6 tw-gap-4 tw-justify-center tw-hidden md:tw-flex tw-overflow-x-auto
            ...
            @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                <button type="button"
                    class="pos-express-finalize no-print {{ $tab_class }} @if (!array_key_exists('mpesa', $payment_types)) hide @endif
                        border-2 tw-border-green-500 text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 font-medium text-sm px-3 py-1.5 text-center"
                    data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                    <span style="white-space: nowrap; display: flex; align-items: center; justify-content: center;">
                        <img style="width:44px; height:34px; min-width:40px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA">
                    </span>
        ...
        <div
            ...
            <div
                ...
                <div class="!tw-w-full md:!tw-w-none !tw-flex md:!tw-hidden !tw-flex-row !tw-items-center !tw-gap-3">
                    ...
                    @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                        <button type="button"
                            class="tw-font-bold tw-text-white tw-cursor-pointer tw-text-xs tw-flex tw-flex-row tw-items-center tw-justify-center tw-gap-1 tw-bg-green-500 tw-p-2 tw-rounded-md tw-w-[5.5rem] pos-express-finalize @if (!array_key_exists('mpesa', $payment_types)) hide @endif"
                            data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                            <img style="width:30px; height:20px; min-width:30px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA">
                        </button>
                    @endif
                ...
                <div class="tw-flex tw-items-center tw-gap-4 tw-flex-row tw-overflow-x-auto">
                    ...
                    @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
                        <button type="button"
                            class="btn-default tw-font-bold tw-text-white tw-cursor-pointer tw-text-xs tw-px-3 tw-py-0.5 tw-rounded-md tw-w-[6rem] tw-flex tw-items-center tw-justify-center tw-gap-1 pos-express-finalize @if (!array_key_exists('mpesa', $payment_types)) hide @endif tw-border tw-border-green-500 tw-border-2"
                            data-pay_method="mpesa" title="@lang('PAY WITH M-PESA')">
                            <span style="white-space: nowrap; display: flex; align-items: center; justify-content: center;">
                                <img style="width:44px; height:34px; min-width:40px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" alt="M-PESA">
                            </span>
                ...
                {{--  recent mpesa payments button --}}
              @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
              <button type="button"
              class="btn-recent-mpesa tw-font-bold tw-rounded-full hover:!tw-bg-blue-500  tw-text-white tw-px-4 tw-h-10 tw-text-xs md:tw-text-sm tw-flex tw-items-center tw-gap-2"
              style="background-color: #10B981;"
              title="@lang('Recent Mpesa Transactions')" id="recent-mpesa-payments">
              <i class="fas fa-money-bill"></i> <span style="white-space: nowrap;">@lang('Recent Mpesa')</span>
          </button>
          @endif
