...
<header-totals class="flex-none max-h-[20vh] min-h-0 w-full {{-- bg-red-400 --}} overflow-y-auto overflow-hidden">
	<div class="row">
...
<main-totals class="flex-grow min-h-0 w-full {{-- bg-yellow-300 --}} overflow-y-auto ">
	...
	<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
		<thead>
			<tr>
				<th class="tex-center tw-text-sm md:!tw-text-base tw-font-bold @if(!empty($pos_settings['inline_service_staff'])) col-md-3  @else col-md-3 @endif">	
					@lang('sale.product') @show_tooltip(__('lang_v1.tooltip_sell_product_column'))
				</th>
				<th class="text-center tw-text-sm md:!tw-text-base tw-font-bold  col-md-4">
					@lang('sale.qty')
				</th>
