...
class HmsBookingController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('hms::bookings.create', compact('status', 'extras', 'walk_in_customer', 'types', 'customer_groups', 'payment_line', 'payment_types', 'pos_settings', 'change_return', 'accounts', 'busines'));
    }
    ...
    public function show($id)
    {
        ...
        return view('hms::bookings.show', compact('extras', 'transaction', 'extras_id', 'booking_rooms', 'busines'));
    ...
    public function edit($id)
    {
        ...
        return view('hms::bookings.edit', compact('status', 'extras', 'transaction', 'extras_id', 'booking_rooms', 'types', 'customer_groups', 'customer_due', 'payment_types', 'pos_settings', 'payment_lines', 'change_return', 'accounts', 'busines'));
    }
