...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        $cashier_role->syncPermissions(['sell.view', 'sell.create', 'sell.update', 'sell.delete', 'sell.payments', 'access_all_locations', 'view_cash_register', 'close_cash_register']);
    ...
    /**
     * Return the default setting for WhatsApp API.
     *
     * @return array
     */
    public function defaultWhatsAppSettings()
    {
        return [
            'enabled' => 0,
            'api_provider' => 'meta', // meta, twilio, other
            'access_token' => '',
            'phone_number_id' => '',
            'business_account_id' => '',
            'verify_token' => '',
            ...
            // Message templates
            'sale_notification_enabled' => 0,
            'sale_message_template' => "Hello {customer_name},\n\nThank you for your purchase at {business_name}!\n\nInvoice: {invoice_no}\nTotal: {total}\nDate: {date}\n\nWe appreciate your business!",
            'payment_reminder_enabled' => 0,
            'payment_reminder_template' => "Hello {customer_name},\n\nThis is a friendly reminder about your pending payment.\n\nInvoice: {invoice_no}\nAmount Due: {amount_due}\nDue Date: {due_date}\n\nPlease contact us if you have any questions.",
            'low_stock_alert_enabled' => 0,
            'low_stock_template' => "Low Stock Alert!\n\nProduct: {product_name}\nCurrent Stock: {current_stock}\nAlert Quantity: {alert_quantity}\n\nPlease reorder soon.",
            // Scheduling
            'schedule_enabled' => 0,
            'schedule_time' => '09:00',
