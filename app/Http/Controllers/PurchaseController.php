                ...
                ->addColumn('action', function ($row) {
                    ...
                    if (auth()->user()->can('purchase.payments') ||
                        ...
                        if ($row->payment_status != 'paid') {
                            ...
                            if (!empty($row->mobile)) {
                                $html .= '<li><a href="#" class="pay_purchase_mpesa" data-id="'.$row->id.'" data-amount="'.($row->final_total - $row->amount_paid).'" data-phone="'.$row->mobile.'"><i class="fas fa-mobile-alt"></i> '.__('lang_v1.mpesa_pay_expense').'</a></li>';
                            }
                        }
