            ...
            return Datatables::of($expenses)
                ->addColumn(
                    ...
                    @if($payment_status != "paid")
                        ...
                        @if(!empty($mobile))
                            <li><a href="#" class="pay_expense_mpesa" data-id="{{$id}}" data-amount="{{$final_total - $amount_paid}}" data-phone="{{$mobile}}"><i class="fas fa-mobile-alt"></i> @lang("lang_v1.mpesa_pay_expense")</a></li>
                        @endif
                    @endif
